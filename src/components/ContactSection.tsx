...
const ContactTile = ({
  icon, label, value, sub, href, accent, accentGradient, delay, badge,
}: {
  icon: React.ReactNode; label: string; value: string; sub?: string;
  href?: string; accent: string; accentGradient?: string; delay: number; badge?: string;
}) => {
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: hovered ? `0 6px 20px -4px ${accent}80` : "none",
            }}
          >
            {icon}
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[#09285A] font-bold text-sm leading-snug truncate"
              style={{ color: hovered ? accent : "#09285A", transition: "color 0.25s" }}>
              {value}
            </p>
    ...
    <div ref={blockRef}>
      <motion.a
        ...
        style={{
          ...
          border: `1.5px solid ${hovered ? "#00C2A860" : "#00C2A825"}`,
          boxShadow: hovered
            ? "0 8px 28px -6px rgba(0,194,168,0.22), inset 0 1px 0 rgba(255,255,255,0.8)"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    ...
                    <div>
                      ...
                      <select value={form.service} onChange={(e) => setForm({ ...form, service: e.target.value })}
                        className="w-full px-4 py-3 rounded-xl bg-white text-gray-900 text-sm focus:outline-none border-2 border-gray-400">
                    ...
                    <div>
                      ...
                      <textarea required rows={5} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                        className="w-full px-4 py-3 rounded-xl bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none text-sm resize-none border-2 border-gray-400"
          ...
          <div ref={sidebarRef} className="lg:col-span-2 w-full space-y-5">
            ...
            >
              ...
              <div className="rounded-2xl overflow-hidden border border-gray-100"
                ...
                <ContactTile icon={<Mail className="w-5 h-5" />} label="Email Us" value="Info@scalesight.in"
                  sub="Opens with prefilled message" href={emailHref} accent="#F97316" delay={0.32} badge="24h reply" />
                <div className="mx-4 h-px bg-gray-100" />
                <ContactTile icon={<MessageCircle className="w-5 h-5" />} label="WhatsApp" value="Chat with us directly"
                  sub="Quick response guaranteed" href="https://wa.me/919023120410" accent="#25D366" delay={0.38} badge="Live" />
                <div className="mx-4 h-px bg-gray-100" />
                <ContactTile icon={<LinkedInIcon />} label="LinkedIn" value="ScaleSight Advisory"
                  sub="Follow for insights & updates" href="https://linkedin.com/company/scalesight" accent="#0A66C2" delay={0.44} />
                <div className="mx-4 h-px bg-gray-100" />
                <ContactTile
                  icon={<InstagramIcon />}
                  label="Instagram"
                  value="@scalesight_global_advisory"
                  sub="Behind-the-scenes & advisory tips"
                  href="https://www.instagram.com/scalesight_global_advisory"
                  accent="#E1306C"
                  accentGradient="linear-gradient(135deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)"
                  delay={0.50}
                  badge="New"
                />
              </div>
